...
java -jar ${HEAP_XMS:-"-Xms256m"} ${HEAP_XMX:-"-Xmx256m"} \
    ...
    -Dfile.encoding=UTF-8 \
	  ...
	  -Dinterfaces.notification.telegram.bottokenkey=${TELEGRAM_BOTTOKEN_KEY} \
	  -Dinterfaces.notification.telegram.bottokenvalue=${TELEGRAM_BOTTOKEN_VALUE} \
	  -Dinterfaces.notification.telegram.chatid=${TELEGRAM_CHAT_ID} \
